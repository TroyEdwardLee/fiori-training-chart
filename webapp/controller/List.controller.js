sap.ui.define([
	"fiori/training/chart/common/BaseController",
	...
	return Controller.extend("fiori.training.chart.controller.List", {
		 ...
		 * @memberOf fiori.training.chart.view.List
		 */
		onInit: function() {
		...
		handlePrdNameValueHelp: function() {
			...
			Fragment.load({
				name: "fiori.training.chart.fragment.PrdNameValueHelpDialog",
				controller: this
		...
		**/
		handleAddPress: function() {
			...
			if (!this._oAddDialog) {
				Fragment.load({
					id: oView.getId(),
					name: "fiori.training.chart.fragment.AddDialog",
					controller: this
		...
		handleEditPress: function() {
			...
			if (!this._oEditDialog) {
				Fragment.load({
					id: oView.getId(),
					name: "fiori.training.chart.fragment.EditDialog",
					controller: this
				}).then(function(oDialog) {
